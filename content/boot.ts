...
export const BOOT_LINES: BootLine[] = [
  ...
  { delay: 140, left: "MEM     counting browser tabs", right: "OH", count: 47, mark: "flare" },
  ...
  { delay: 160, left: "" },
  { delay: 90, left: "Booting from app 0 (home).", tone: "fg" },
  { delay: 70, left: "" },
  {
    delay: 55,
  ...
  {
    delay: 50,
    left: `[    0.041] dock: ${DOCK_APPS.length} apps, 0 standups`,
    tone: "dim",
  },
  {
    delay: 48,
  ...
  {
    delay: 48,
    left: "[    0.120] contact: drafts a note, then mailto",
    tone: "dim",
  },
  {
    delay: 48,
    left: "[    0.168] experience: the glow follows your scroll. sorry.",
    tone: "dim",
  },
  {
    delay: 48,
    left: `[    0.210] projects: ${featuredProjects.length} modules. please be gentle.`,
    tone: "dim",
  },
  {
    delay: 48,
